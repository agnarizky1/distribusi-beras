...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('/src/assets/compiled/svg/favicon.svg') }}" type="image/x-icon">
    ...
    <link rel="stylesheet" href="{{ asset('/src/assets/extensions/@fortawesome/fontawesome-free/css/all.min.css') }}">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="{{ route('superadmin.dashboard') }}"><img
                                    src="{{ asset('/src/assets/compiled/svg/logo.svg') }}" alt="Logo"
                                    srcset=""></a>
                        </div>
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item  ">
                            <a href="{{ route('stok') }}" class='sidebar-link'>
            ...
            <footer>
                <div class="footer clearfix mb-0 text-muted">
                    <div class="float-start">
                        <p>2023 &copy; Distribusi beras</p>
                    </div>
                    <div class="float-end">
