...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('assets/images/icons8-pill-96.png') }}" />
    ...
    <main class="form-signin w-100 m-auto">
        <form action="{{ route('do.register') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-floating">
                ...
                <div class="mb-3">
                    <small class="d-block text-center mt-3">Already have account? <a href="/">Login</a></small>
                </div>
                {{-- <p class="mt-5 mb-10 text-body-secondary">&copy; ZNR</p> --}}
        </form>
    </main>
