                                ...
                                <tbody>
                                    <tr>
                                        <td class="text-center">
                                            <img src="{{ asset('uploads/ktp/' . $toko->foto_ktp) }}"
                                                style="height: auto; max-width: 400px;" alt="Foto KTP" class="img-fluid">

                                        </td>
                                        <td class="text-center">
                                            <img src="{{ asset('uploads/toko/' . $toko->foto_toko) }}"
                                                style="height: auto; max-width: 400px;" alt="Foto Toko" class="img-fluid">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <a href="https://www.google.com/maps?q={{ $toko->koordinat }}" target="_blank"
