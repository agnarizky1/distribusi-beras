@extends('layouts.app')
@section('link')
    <<<<<<< HEAD <link rel="stylesheet" href="{{ asset('assets/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css') }}">
    ...
    @section('content')
        ...
        <!-- Modal -->
    <<<<<<< HEAD @section('link') <link rel="stylesheet" href="{{ asset('assets/css/virtual-select.min.css') }}" />
    @endsection
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h1 class="modal-title fs-5"
                                                                            id="exampleModalLabel">Input Distribusi
                                                                        </h1>
                                                                                        ...
                                                                                        <div class="col-12 col-lg-12">
                                                                                            <div class="card">
                                                                                                <div class="card-body">
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            class="col-md-6">
                                                                                                            <label
                                                                                                                for="tanggal_distribusi">Tanggal
                                                                                                                Distribusi</label>
                                                                                                            <input
                                                                                                                type="date"
                                                                                                                class="form-control"
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <button
                                                                                                                class="btn btn-success btn-sm text-white rounded"
                                                                                                                id="simpanBtn"><i
                                                                                                                    class="fa fa-save"></i>
                                                                                                                Tambah
                                                                                                                Barang</button>
                                                                                                ...
                                                                                                <div class="text-end">
                                                                                                    ...
                                                                                                    <button
                                                                                                        id="simpanDistribusiBtn"
                                                                                                        class="btn btn-primary rounded"><i
                                                                                                            class="fa fa-save"></i>
                                                                                                        Simpan
                                                                                                        Distribusi</button>
                                                                                                </div>
                                                                                                ...
                                                                                                document.querySelectorAll('#transaction-records tr').forEach(function(row) {
                                                                                                    ...
                                                                                                    document.getElementById('simpanDistribusiBtn').addEventListener('click', function() {
                                                                                                        ...
                                                                                                        document.querySelectorAll('#transaction-records tr').forEach(function(row) {
                                                                                                            ...
                                                                                                            var jenisBeras = row.querySelector('td:nth-child(2)').textContent;
                                                                                                            var gradeBeras = row.querySelector('td:nth-child(3)').textContent;
                                                                                                            var hargaBeras = parseFloat(row.querySelector('td:nth-child(4)')
                                                                                                                .textContent);
                                                                                                            var subtotal = parseInt(row.querySelector('td:nth-child(6)')
                                                                                                                .textContent, 10);
                                                                                                            var jumlah = subtotal / hargaBeras;
                                                                                                            var beratBeras = parseFloat(namaBeras.match(/\d+/));
                                                                                                            var subTotalBeras = jumlah * beratBeras;
