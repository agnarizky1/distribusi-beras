...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row mb-2">
                                ...
                                <div class="col-md-3">
                                    <select class="form-select" id="pilihanDiskon" name="pilihanDiskon" aria-label="Default select example"
                                        required>
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" style="min-width: 50px;" id="diskon" name="diskon" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12 text-end">
            ...
            <div class="modal-footer">
                <button id="cekToko" class="btn btn-primary text-white rounded"
