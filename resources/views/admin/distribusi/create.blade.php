            ...
            <div class="col-12 col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="beras" id="beras" class="form-control select2">
                                    ...
                                    @foreach ($beras as $item)
                                        <option value="{{ $item->id }}" data-grade="{{ $item->grade_beras }}"
                                            data-jenis="{{ $item->jenis_beras }}" data-price="{{ $item->harga }}">
                                            {{ $item->nama_beras }} {{ $item->berat }} Kg</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-4 mb-3">
                            ...
                            <div class="col-md-12 text-end">
                                <button class="btn btn-success btn-sm text-white rounded" id="simpanBtn"><i
                                        class="fa fa-save"></i> Tambah Barang</button>
                            </div>
                        </div>
                        ...
                        <div class="text-end">
                            <button id="simpanDistribusiBtn" class="btn btn-sm btn-primary rounded"><i
                                    class="fa fa-save"></i> Simpan Distribusi</button>
                        </div>
                    </div>
                </div>
            </div>
